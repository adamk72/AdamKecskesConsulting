...
export const TeamLeftSide = [
  <SimpleCard className='justify' title='We Are Better Together'>
    ...
    <p>
      In teams that I manage, I rely heavily on the expertise and fact-oriented
      opinions of each person to make better overall decisions. I distinctly
      enjoy learning about the innovative solutions that my teams come up with.
    </p>
    <p>
